...
<div class="at-body">
   <div class="at-container">
      <div class="at-content">
        <div class="page-wrap">
          <div class="article-title">제1조 총칙</div>
          <ol>
            <li>
          ...
          <ol>
            <li>
              ...
              <ol>
                ...
                <li>
                  서비스 제공, 콘텐츠 제공, 웹 컨설팅 기초 자료 확보, 마케팅
                  활용, 상담 신청 처리, 구매 대행 및 요금 결제 등을 위한 원활한
                  의사소통 경로 확보
                </li>
                <li>
          ...
          <ol>
            <li>필수수집항목 : 이름(업체명), 연락처, 이메일</li>
            <li>개인정보 수집방법 : 홈페이지(회원가입,견적문의,SSL보안인증)</li>
          </ol>
          ...
          <ol>
            ...
            <li>
              ...
              공유할 경우에는 사전에 귀하께 제휴사가 누구인지, 제공 또는
              공유되는 개인정보항목이 무엇인지, 왜 그러한 개인정보가 제공되거나
              공유되어야 하는지, 그리고 언제까지 어떻게 보호·관리되는지에 대해
              개별적으로 전자우편 및 서면을 통해 고지하여 동의를 구하는 절차를
              거치게 되며, 귀하께서 동의하지 않는 경우에는 제휴사에게 제공하거나
              제휴사와 공유하지 않습니다.
            </li>
            <li>
            ...
            <li>
              ...
              <ol>
                ...
                <li>
                  ...
                  재화공급 기록(5년), 불만 또는 분쟁처리 기록(3년)
                </li>
              </ol>
            </li>
            <li>
              위 보유기간에도 불구하고 계속 보유하여야 할 필요가 있을 경우에는
              귀하의 동의를 받겠습니다.
            </li>
          </ol>
          ...
          <ol>
            <li>
              파기절차 : 귀하가 회원가입 등을 위해 입력하신 정보는 목적이 달성된
          ...
          <ol>
            ...
            <li>
              ...
              동의철회를 요청할 수 있으며, 이러한 요청이 있을 경우 본 사이트는
              지체없이 필요한 조치를 취합니다.
            </li>
          </ol>
          <div class="article-title">
          ...
          <p>
            <span
              ...
              도난, 누출, 변조 또는 훼손되지 않도록 안전성 확보를 위하여 다음과
              같은 기술적 대책을 강구하고 있습니다.</span
            >
          </p>
          <ol>
            <li>
          ...
          <ol>
            ...
            <li>
              ...
              서비스제공자의 개인정보호 관련 지시엄수, 개인정보에 관한 비밀유지,
          ...
          <ol>
            <li>
              ...
              있는 창구를 개설하고 있습니다. 개인정보와 관련한 불만이 있으신
              분은 본 홈페이지의 개인정보 관리책임자에게 의견을 주시면 접수 즉시
              조치하여 처리결과를 통보해 드립니다.
              <ol>
                <li>개인정보 보호책임자 성명 : 임규성</li>
                <li>전화번호 : 02-546-7946~7</li>
                <li>이메일 : master@withbrother.co.kr</li>
              </ol>
            </li>
            <li>
              ...
              <ol>
                <li>
                  개인분쟁조정위원회 (<a
                    ...
                    title="개인분쟁조정위원회 바로가기"
                    target="_blank">www.1336.or.kr</a
                  >&nbsp;/ 1336)
                </li>
                <li>
                  정보보호마크인증위원회 (<a
                    href="http://www.eprivacy.or.kr/"
                    title="정보보호마크인증위원회 바로가기"
                    target="_blank">www.eprivacy.or.kr</a
                  >&nbsp;/ 02-580-0533~4)
                </li>
                <li>
                  대검찰청 인터넷범죄수사센터 (<a
                    href="http://icic.sppo.go.kr/"
                    title="대검찰청 인터넷범죄수사센터 바로가기"
                    target="_blank">icic.sppo.go.kr</a
                  >&nbsp;/ 02-3480-3600)
                </li>
                <li>
                  경찰청 사이버테러대응센터 (<a
                    href="http://www.ctrc.go.kr/"
                    title="경찰청 사이버테러대응센터 바로가기"
                    target="_blank">www.ctrc.go.kr</a
                  >&nbsp;/ 02-392-0330)
                </li>
              </ol>
            </li>
          </ol>
          <div class="article-title">부칙 시행일 등</div>
          <ol>
            <li>본 방침은 2013년 01월 01일부터 시행합니다.</li>
          </ol>
        </div>
      </div>
    </div>
