...
<ul class="tab">
  <li><a href="/info/transportation">iPASS</a></li>
  <li class="active"><a href="/info/transportation02">Taipei Pass</a></li>
  ...
  <div class="culture">
    <ul class="box step1">
      ...
      <li>
        ...
        <div class="content">
          <p class="text">
            ...
            <br />
            베이터우 주즈후 노선, 무자핑시 노선, 황관 북해안 및 황금 푸룽 노선 포함)
            및 지하철을 <br />
            무제한 이용할 수 있습니다. 마오콩 케이블카 1일권의 경우, 케이블카 무제한
            탑승이 가능합니다. <br />
            카드를 결제 단말기의 「이지카드 라벨」이 표시된 센서에 가볍게 갖다 대면
            즐거운 타이베이 여행을 <br />
            바로 시작할 수 있습니다.
          </p>
        </div>
      ...
      <li>
        ...
        <div class="content">
          <p class="text">4자리 노선번호의 광역여객버스는 사용이 불가합니다.</p>
        </div>
      </li>
      <li>
        <div class="name">
    ...
    <div class="box step2">
      ...
      <div class="con">
        <ul class="method">
          <li>
            <div class="image">
              <img src="/img/m06_05_02_01.png" class="pc-img" />
              <img src="/img/mm06_05_02_01.png" class="m-img" />
            </div>
            <div class="content">
              <h4>최고 60% 할인</h4>
              <p>
          ...
          <li>
            <div class="image">
              <img src="/img/m06_05_02_02.png" class="pc-img" />
              <img src="/img/mm06_05_02_02.png" class="m-img" />
            </div>
            <div class="content">
              <h4>관광 명소 티켓 포함</h4>
              <p>
          ...
          <li>
            <div class="image">
              <img src="/img/m06_05_02_03.png" class="pc-img" />
              <img src="/img/mm06_05_02_03.png" class="m-img" />
            </div>
            <div class="content">
              <h4>대중교통 무제한 탑승</h4>
              <p>
          ...
          <li>
            <div class="image">
              <img src="/img/m06_05_02_04.png" class="pc-img" />
              <img src="/img/mm06_05_02_04.png" class="m-img" />
            </div>
            <div class="content">
              <h4>쇼핑 할인 혜택</h4>
              <p>
        ...
        <ul class="ticket">
          ...
          <li>
            <img src="/img/ticket2.jpg" />
            <span>고궁박물관</span>
          </li>
          <li>
            <img src="/img/ticket3.jpg" />
            <span>스린공식거주지</span>
          </li>
          <li>
            <img src="/img/ticket4.jpg" />
            <span>미라마엔터테인먼트파크</span>
          </li>
          <li>
            <img src="/img/ticket5.jpg" />
            <span>켓케어 케이블카</span>
          </li>
          <li>
            <img src="/img/ticket6.jpg" />
            <span>타이베이시 동물원</span>
          </li>
          <li>
            <img src="/img/ticket7.jpg" />
            <span>어린이천국</span>
          </li>
          <li>
            <img src="/img/ticket8.jpg" />
            <span>포켓박물관</span>
          </li>
          <li>
            <img src="/img/ticket9.jpg" />
            <span>천문학 교육센터</span>
          </li>
          <li>
            <img src="/img/ticket10.jpg" />
            <span>대만 국립과학교육센터</span>
          </li>
          <li>
            <img src="/img/ticket11.jpg" />
            <span>타이베이 미술관</span>
          </li>
          <li>
            <img src="/img/ticket12.jpg" />
            <span>타이베이 현대미술박물관</span>
          </li>
          <li>
            <img src="/img/ticket13.jpg" />
            <span>신베이시13라인박물관</span>
          </li>
          <li>
            <img src="/img/ticket14.jpg" />
            <span>린벤위안가든</span>
          </li>
          <li>
            <img src="/img/ticket15.jpg" />
            <span>금 박물관</span>
          </li>
          <li>
            <img src="/img/ticket16.jpg" />
            <span>담수 고대박물관</span>
          </li>
          <li>
            <img src="/img/ticket17.jpg" />
            <span>담수 부두</span>
          </li>
          <li>
            <img src="/img/ticket18.jpg" />
            <span>주밍미술관</span>
          </li>
          <li>
            <img src="/img/ticket19.jpg" />
            <span>예류지질공원</span>
          </li>
          <li>
            <img src="/img/ticket20.jpg" />
            <span>피스 아일랜드파크</span>
          </li>
          <li>
            <img src="/img/ticket21.jpg" />
            <span>폴 스카이 라이트 박물관</span>
          </li>
          <li>
            <img src="/img/ticket22.jpg" />
