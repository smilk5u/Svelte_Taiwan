...
<header>
  <div class="header_contain">
    <div class="gnb_wrap">
      ...
      <ul id="gnb">
        <li>
          <button type="button" class="active">대만 정보</button>
          <ul class="gnb_menu">
            <li>
        ...
        <li>
          ...
          <ul class="gnb_menu">
            ...
            <li>
              <a href="/satisfact/magazine">월간 매거진</a>
            </li>
            <li>
              <a href="/satisfact/satisfact">프로대만족</a>
            </li>
            <li>
              <a href="/satisfact/travel_tips">여행 Tips</a>
            </li>
          </ul>
        </li>
        <li>
          ...
          <ul class="gnb_menu">
            <li>
              <a href="/introduction/tourism_board">관광청 소개</a>
            </li>
            <li>
              <a href="/introduction/director_general">국장소개</a>
            </li>
            <li><a href="/introduction/notice">공지사항</a></li>
            <li>
              <a href="/introduction/press_release">보도자료</a>
            </li>
            <li>
              <a href="/introduction/korean_office">찾아오시는 길</a>
            </li>
          </ul>
        </li>
      </ul>
...
<div class="mobile_header">
  <div class="mobile_header_top">
    <h1 class="logo">
      <a href="/"><img src="/img/layout/logo_m.png" alt="대만관광청 로고" /></a>
    </h1>
