...
<header>
  ...
  <ul class="link_buttons">
    <li class="go_home">
      <a target="_blank" href="https://www.taiwantour.or.kr/">홈페이지 가기</a>
    </li>
    ...
    <div class="overlay" id="overlay">
      <nav class="overlay-menu">
        <ul class="mobile_link_buttons">
          ...
          <li class="select_account">
            <button on:click={clickHandler} class="triangle">관리자 <span>▼</span></button>
            {#if isExpanded}
              <ul transition:slide>
                <li>관리자정보</li>
                <li>기본환경</li>
                <!-- <li>로그아웃</li> -->
                <li on:click={handleLogout} on:keydown={handleLogoutKey} tabindex="-1">로그아웃</li>
              </ul>
            {/if}
          </li>
        </ul>
